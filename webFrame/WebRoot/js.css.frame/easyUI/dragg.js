(function($) {
    function drag(e) {
        var opts = $.data(e.data.target, 'draggable').options; // 获取存储在e.data.target中的draggable的option数据
        var dragData = e.data;
    ...
    function doDown(e) {
        ...
        drag(e);
        applyDrag(e);
        opts.onStartDrag.call(e.data.target, e); //预调用onStartDrag, 自己调自己 call中 opts == e.data.target
        return false;
    }
    ...
    $.fn.draggable = function(options, param) {
        ...
        return this.each(function() {
            ...
            $.data(this, 'draggable', {     // 将数据{option:opts,handle:handle} 绑定到this对象上,key为为draggable
                options : opts,
                handle : handle
            });
            handle.bind('mousedown.draggable', { //绑定的命名空间.draggable,解除绑定时更精确
                target : this
            }, onMouseDown);
            ...
            function onMouseDown(e) {
                ...
                if (opts.onBeforeDrag.call(e.data.target, e) == false) {  //预先调用onbefore方法, 未初始化为空
                    return;
                }
