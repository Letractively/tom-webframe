...
public class AppUtils {
	public static String autoException(Throwable _e, String _className) throws Exception {
		...
		if (frame == null) {
			while (_e.getCause() != null) {  //先判断上级原因是否存在,如果不存在直接跳过
		...
		Log.writeLog(frame.toString(), (Exception) _e);
